  ...
  return (
    <section className="help-section">
      ...
      <ol className="help-list numbered">
        <li>
          <strong>Бэклог</strong> — видимые задачи (обычно до 5). Рядом «+N» — скрытая колода: когда
          карточку тянут в «К работе», из колоды выходит следующая. Колода конечная: если она пуста и
          на доске ничего не осталось — новых задач больше нет.
        </li>
        <li>
