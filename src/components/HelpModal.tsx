  ...
  return (
    <section className="help-section">
      ...
      <ol className="help-list numbered">
        ...
        <li>
          <strong>К релизу / Выпущено</strong> — готово к биллингу и уже выпущено клиентам.
        </li>
        <li>
      ...
      <ol className="help-list numbered">
        ...
        <li>
          <strong>Шаг</strong> — на каком этапе дня вы сейчас (стендап → работа → … → событие).
        </li>
        <li>
  ...
  return (
    <section className="help-section">
      ...
      <ol className="help-steps">
        ...
        <li>
          <strong>Событие дня</strong> — прочитайте карточку события (иногда выбор Да/Нет) и идите к
          следующему дню.
        </li>
      </ol>
      <div className="help-callout">
